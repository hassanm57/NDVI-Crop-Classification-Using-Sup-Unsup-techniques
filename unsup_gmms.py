...
Original file is located at
    https://colab.research.google.com/drive/1AwXtOkkuFZy07NlZJH0F1JsBfY7SFRNO
...
clusters = gmm.fit_predict(balanced_data_0)
...
# Visualize clusters
visualize_clusters(balanced_data_0, clusters, title='GMMS Clustering Without PCA')
...
# Apply GMM on PCA-transformed data

gmm = GaussianMixture(n_components=2, covariance_type='full', random_state=42)
clusters = gmm.fit_predict(balanced_data_0)

clusters_pca = gmm.fit_predict(X_pca)
...
# Plot the confusion matrix for GMM with PCA
