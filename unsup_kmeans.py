...
Original file is located at
    https://colab.research.google.com/drive/1zEzOLGkoOklj9U9ArwlFgScmZ_RlIhJG
...
selector = SelectKBest(score_func=f_classif, k=3)  # Select top k features
...
# Fit K-Means with clusters=2
kmeans = KMeans(n_clusters=2, random_state=41)
clusters = kmeans.fit_predict(balanced_data_0)

# Add cluster labels to the dataset
balanced_data_0['cluster'] = clusters

# Visualize the clusters
plt.scatter(balanced_data_0.iloc[:, 0], balanced_data_0.iloc[:, 1], c=clusters, cmap='viridis')
...
# Visualize clusters
visualize_clusters(balanced_data_0, clusters, title='K-Means Clustering Without PCA')
...
pca_data = pca.fit_transform(balanced_data)
...
# Add the PCA cluster labels to the dataset
balanced_data['cluster_pca'] = clusters_pca

"""Visualise The Clusters After Applying PCA"""

# Visualize the clusters after PCA
plt.figure(figsize=(6, 6))
plt.scatter(pca_data[:, 0], pca_data[:, 1], c=clusters_pca, cmap='viridis', s=10)
...
# Plot the confusion matrix for K-Means with PCA
